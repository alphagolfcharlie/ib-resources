...
export function ElementCard({ element }: ElementCardProps) {
    ...
    const getCategoryColor = (category: string): string => {
        const colors: Record<string, string> = {
            "alkali-metal": "bg-red-50 border-red-200 hover:bg-red-100 text-red-800",
            "alkaline-earth-metal": "bg-orange-50 border-orange-200 hover:bg-orange-100 text-orange-800",
            "transition-metal": "bg-blue-50 border-blue-200 hover:bg-blue-100 text-blue-800",
            "post-transition-metal": "bg-rose-50 border-rose-200 hover:bg-rose-100 text-rose-800",
            "metalloid": "bg-lime-50 border-lime-200 hover:bg-lime-100 text-lime-800",
            "nonmetal": "bg-purple-50 border-purple-200 hover:bg-purple-100 text-purple-800",
            "halogen": "bg-pink-50 border-pink-200 hover:bg-pink-100 text-pink-800",
            "noble-gas": "bg-indigo-50 border-indigo-200 hover:bg-indigo-100 text-indigo-800",
            "lanthanide": "bg-amber-50 border-amber-200 hover:bg-amber-100 text-amber-800",
            "actinide": "bg-emerald-50 border-emerald-200 hover:bg-emerald-100 text-emerald-800"
        };
    ...
    return (
        <div className="relative">
          ...
          ${isHovered ? "scale-105 shadow-lg z-10" : "shadow-sm"}
        `}
